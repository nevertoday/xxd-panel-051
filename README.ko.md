...
<table>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091470045973262409"><img src="./assets/examples/sample-01.jpg" alt="XXD Panel 051 예시 1"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091470045973262409"><img src="./assets/examples/sample-02.jpg" alt="XXD Panel 051 예시 2"></a></td>
  </tr>
  <tr>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091470045973262409"><img src="./assets/examples/sample-03.jpg" alt="XXD Panel 051 예시 3"></a></td>
    <td width="50%"><a href="https://x.com/xiaoxiaodong01/status/2091470045973262409"><img src="./assets/examples/sample-04.jpg" alt="XXD Panel 051 예시 4"></a></td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-05.png" alt="XXD Panel 051 예시 5"></td>
    <td width="50%"><img src="./assets/examples/sample-06.png" alt="XXD Panel 051 예시 6"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-07.png" alt="XXD Panel 051 예시 7"></td>
    <td width="50%"><img src="./assets/examples/sample-08.png" alt="XXD Panel 051 예시 8"></td>
  </tr>
</table>

## 3:4 세로형 상하 구성 예시

위 16:9 예시와 같은 네 개의 독립 소스를 완전한 3:4 상하 캔버스로 다시 생성했습니다. 위쪽은 현실 사진을 유지하고 아래쪽은 Panel 051의 원본 프롬프트에 따라 재구성합니다. 영어 문구는 각 사진의 내용·분위기·함의에서만 생성했으며 모든 결과를 개별 검수했습니다.

<table>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-09.png" alt="XXD Panel 051 추가 상하 예시 1"></td>
    <td width="50%"><img src="./assets/examples/sample-10.png" alt="XXD Panel 051 추가 상하 예시 2"></td>
  </tr>
  <tr>
    <td width="50%"><img src="./assets/examples/sample-11.png" alt="XXD Panel 051 추가 상하 예시 3"></td>
    <td width="50%"><img src="./assets/examples/sample-12.png" alt="XXD Panel 051 추가 상하 예시 4"></td>
  </tr>
</table>

> [샤오샤오둥（@xiaoxiaodong01）](https://x.com/xiaoxiaodong01/status/2091470045973262409) · 2026년 8월 23일<br>
> GPT2 × 종이 오리기 × 분경 × 고급스러움 × 미학 프롬프트 × VOL.051

<p align="center"><a href="https://x.com/xiaoxiaodong01/status/2091470045973262409">원문 게시물과 전체 프롬프트 보기 →</a></p>

이 예시는 051의 미학적 의도를 보여 줄 뿐이며, 예시의 주제, 구성, 색상, 문구, 이전 캔버스 비율은 생성 참고나 현재 기본값이 되지 않습니다.

> 종이 공예 미니어처 · 가로형 부유 풍경대 · 손작업 증거 · 에어리 블루 · 넓은 여백

원본에서 가장 알아보기 쉬운 주체와 서사 관계를 손으로 만든 종이 미니어처 설치물로 바꿉니다. 식별 가능한 중심 모형 하나, 가볍고 좁은 가로 풍경대 하나, 근거 있는 소수의 보조 모형, 실제 종이 섬유와 넓은 옅은 종이 여백으로 구성합니다.
...
**Panel 051**은 원본 사진의 핵심을 보존하면서 다음과 같은 시각 방향을 원하는 작업에 적합합니다: **사진의 관계를 가볍고 만질 듯한 종이 미니어처로**. 먼저 용도와 원하는 결과를 확인한 뒤 구성, 크기, 텍스트와 전달 형식을 결정합니다.
...
> XXD Panel 051으로 이 이미지를 작업하고, 먼저 가장 어울리는 구성과 크기를 추천해 줘.
...
## 빠른 판단: XXD Panel 051이 나에게 맞을까요?

| 궁금한 점 | 이 스타일이 주는 답 |
|---|---|
| **얻게 되는 결과** | 사진의 관계를 가볍고 만질 듯한 종이 미니어처로 |
| **한눈에 알아볼 특징** | 종이 공예 미니어처 · 가로형 부유 풍경대 · 손작업 증거 · 에어리 블루 · 넓은 여백 |
...
```text
주체·윤곽·자세·서사 관계 고정 → 고유 단서 3개 보존 → 식별 가능한 손제작 미니어처 재구성 → 필요한 보조 모형만 추출 → 좁은 가로형 부유 풍경대에 배치 → 종이 섬유·접힌 가장자리·절단면·겹 두께·작은 오차 노출 → 부드러운 매크로 빛으로 부피 형성 → 넓은 옅은 종이 면 유지 → 문구를 작품 서명처럼 통합
```

무관한 사진으로 바꿔도 인식성, 모형 구조, 재료 선택, 풍경대 리듬, 색 관계와 문구가 실질적으로 변하지 않는다면 이 Panel의 결과가 아닙니다.

## 완성작에서 바로 알아볼 수 있는 스타일 특징

- 원본 고유 단서를 최소 3개 보존해 중심 손제작 모형이 한눈에 식별되게 합니다.
- 중심 주체 하나와 좁은 가로형 부유 풍경대 하나만 만들고, 보조 모형은 원본 근거를 갖고 더 작고 조용하게 둡니다.
- 크기 변화, 겹침, 작은 전경과 배경으로 깊이를 만들며 딱딱한 대칭과 두꺼운 받침을 피합니다.
- 종이 섬유, 접힌 가장자리, 절단면, 겹 두께, 잔털, 접합부와 작은 제작 오차를 부드러운 확산 매크로 빛 아래 드러냅니다.
- 에어리 블루를 아이보리, 크림, 옅은 베이지, 회녹색, 세이지, 건축 중성색과 균형 있게 사용하며 뮤트 블러시는 작은 점만 허용합니다.
- 플라스틱 CG, 장난감 전시, 유아적 공예, 범용 디오라마, 과밀, 과도한 귀여움, 전자상거래 진열, 평면 벡터 대체, 탁함과 황변을 거부합니다.

전체 규칙은 [SKILL.md](SKILL.md)와 [런타임 어댑터](references/xxd-panel-051-prompt.en.md)를 참조하세요. 원문의 미학을 보존하지만 역사적인 3:4 화면은 숨은 기본값이 아닙니다.
...
이미지 폴더를 직접 전달하면 이 병사 Skill이 같은 Panel 051의 원본 미학으로 일괄 처리합니다. 일반 래스터 형식을 기본적으로 재귀 탐색하고 수량을 먼저 알린 뒤 모드·크기·텍스트·언어를 한 번만 확인합니다. 각 이미지는 내용이나 문구가 섞이지 않도록 독립 생성하며 전체 배치는 하나의 평면 작업 디렉터리만 사용합니다. 개별 실패는 기록하고 이후 이미지를 조용히 누락하지 않습니다.
...
/xxd-panel-051 photo.jpg --mode top-bottom --size auto --text prompt --locale ko-KR

# 좌우 비교: 3:2 가로형, 글자 없음
/xxd-panel-051 photo.jpg --mode left-right --size 3:2 --text none

# 디자인 전용: 9:16 휴대폰 세로형, 한국어 문구
/xxd-panel-051 photo.jpg --mode design-only --size 9:16 --text prompt --locale ko-KR
...
/xxd-panel-051 photo.jpg --mode design-only --size 3:4 --text prompt --locale ko-KR

# 정확한 문구를 재작성·번역·제목 추가 없이 사용
/xxd-panel-051 photo.jpg --mode design-only --size 3:4 --copy "빛을 이곳에 남겨 두기" --locale ko-KR

# 2개 모드 × 3개 크기로 독립적인 완성 구도 6개 생성
/xxd-panel-051 photo.jpg --mode top-bottom,design-only --size 1:1,3:4,9:16 --text prompt --locale ko-KR

# 폴더 전체에 Panel 051 적용, 공통 설정은 한 번만 확정
/xxd-panel-051 "/path/to/photos" --mode design-only --size auto,9:16 --text prompt --locale ko-KR
...
Claude Code 사용자는 같은 폴더를 `~/.claude/skills/xxd-panel-051`에 연결할 수 있습니다. 설치 후 세션을 다시 시작하세요.

전체 사양: [Skill](SKILL.md) · [원본 자료](references/original-prompt/zh-CN.md) · [영문 런타임 어댑터](references/xxd-panel-051-prompt.en.md) · [중문 런타임 어댑터](references/xxd-panel-051-prompt.zh-CN.md)
...
<div align="center"><strong>사진을 장난감으로 만드는 것이 아니라, 그 실제 관계를 종이 안에 접어 넣습니다.</strong></div>
