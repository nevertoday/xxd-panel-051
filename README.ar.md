...
لهذا الإحباط صنعت **Panel 051**. هو لا يضع قالباً فوق الصورة؛ بل يحدد أولاً ما لا يجوز فقدانه، ثم يترجمه إلى **طيّ علاقات الصورة داخل عالم ورقي مصغّر وخفيف قابل للمس**.
